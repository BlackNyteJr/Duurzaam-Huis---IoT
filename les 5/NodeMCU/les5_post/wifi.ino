...
const String serverIP = "39490.hosts2.ma-cloud.nl"; // Ma cloud url or localhost IP
const String serverDirectory = "duurzaamhuis/post.php";
const uint8_t thumbprint[20] = {0x9e, 0xf,5 0xf0, 0x42, 0xf0, 0x61, 0x48, 0x66, 0xcf, 0xa5, 0xf6, 0x12, 0xf6, 0x7f, 0x39, 0xa3, 0x3f, 0x52, 0x5c, 0x32, 0x88, 0xcf, 0xd3, 0xad, 0x63, 0x6a, 0xa3, 0xba, 0x46, 0x6d, 0x61, 0xbd};
String URL = "";
